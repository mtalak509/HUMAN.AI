...
- [x] **WRITE-01**: Graph Writer создаёт Candidate + все связанные узлы через MERGE ✅ Фаза 6
- [x] **WRITE-02**: Graph Writer создаёт Fact-узлы с провенансом (ссылка на Document) ✅ Фаза 6
- [x] **WRITE-03**: Денормализация: прямые связи Candidate→Skill для скорости поиска ✅ Фаза 6
- [x] **WRITE-04**: Повторный запуск на том же документе не создаёт дублей ✅ Фаза 6
